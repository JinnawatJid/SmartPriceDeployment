...
start "" "C:\Program Files\Google\Chrome\Application\chrome.exe" --remote-debugging-port=9222 --remote-allow-origins=* --user-data-dir="%TEMP%\chrome-debug-profile" "http://192.192.0.36:8080/BCTNG" "http://192.192.0.37:8000/"
